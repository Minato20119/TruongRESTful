...
@AssociationOverrides({
		@AssociationOverride(name = "primaryKey.studentCourseEnrolment", joinColumns = @JoinColumn(name = "registration_id")) })
public class Student_Tests_Taken implements Serializable {
	 ...
	 * 
	 * @Column(name="registration_id") private int registrationId;
	 */

	private Student_Tests_TakenId primaryKey;
